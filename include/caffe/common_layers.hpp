...
template <typename Dtype>
class SoftmaxProductLayer : public Layer<Dtype> {
 public:
  explicit SoftmaxProductLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "SoftmaxProduct"; }
